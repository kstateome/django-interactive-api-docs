...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APIMethod.method_call'
        db.add_column('api_docs_apimethod', 'method_call',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APIMethod.method_call'
        db.delete_column('api_docs_apimethod', 'method_call')
    ...
    models = {
        ...
        'api_docs.apimethod': {
            ...
            'display_url': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'method_call': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
